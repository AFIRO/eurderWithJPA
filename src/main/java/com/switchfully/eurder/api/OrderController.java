...
public class OrderController {
    ...
    public OrderDTO createOrder(@RequestParam(value = "customerId") int customerId, @RequestBody CreateOrderDTO dto) {
    ...
    public OrderReportDTO getReportOfCustomerOrders(@RequestParam(value = "customerId") int customerId) {
